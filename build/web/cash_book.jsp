        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div id="div_print" style="background-color: #030303; color: #ffffff">
                    <center>
                        <h3 style="font-family: fontawaesome" class="text-primary text-center"><b>Cash-Book (Realme)</b></h3>
                        <h4>Date: <script> document.write(new Date().toLocaleDateString('en-GB'));</script></h4>
                
                        <table  border="2" width="90%" class="table-condensed table-responsive" >
                            <thead>
                                <tr>

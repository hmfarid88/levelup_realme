...
try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
            ...
            <div class="row">
                <div class="col-sm-12">
                                ...
                                <center>
                                    ...
                                    Contact Person: Hasan 01719-412857
            ...
            try {
                con = Database.getConnection();
                String query = "select SI_NO, MODEL, QTY, RATE, PAYMENT, PAY_TYPE, DATE from company_statement where COMPANY='"+ company +"' and YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE())";
                ps = con.prepareStatement(query);
                rs = ps.executeQuery();
                while (rs.next()) {

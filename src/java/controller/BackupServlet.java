...
//compose message
        try {
            ...
            message.setSubject("Data Backup From Realme");
                        
        MimeBodyPart messageBodyPart = new MimeBodyPart();
        Multipart multipart = new MimeMultipart();
       
        String file = "D:\\Level Up\\Backup File\\realme_dist.sql";
        
        String fileName = "realme_dist.sql";
        ...
        message.setContent(multipart);
            ...
            File f=new File("D:\\Level Up\\Backup File\\realme_dist.sql");
            f.delete();
